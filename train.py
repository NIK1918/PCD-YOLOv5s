...
Usage:
    ...
    $ python path/to/train.py --data coco128.yaml --weights '' --cfg yolov5s-change sppf to sppf sppfcspc.yaml --img 640  # from scratch
"""
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/PCD-YOLOv5s.yaml', help=' path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/Column Detection.yaml', help='dataset.yaml path')
